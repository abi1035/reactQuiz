...
function reducer(state,action){
  ...
  switch (action.type) {
    ...
    const question=state.questions.at(state.index);
      ...
      case "restart":
        return {...state, status:"active", index:0, answer:null, points:0,secondsRemaining:null}
...
function App() {
  ...
  return (
   ...
   <Content className='main'>
    ...
    {status==="finished" && <Finish maxPossiblePoints={maxPossiblePoints} points={points} highScore={highScore} dispatch={dispatch}/>}
